<div>
    ...
    " />
            <span wire:loading wire:target='image' class="text-danger text-red-600/50">loading image loading...</span>
        </label>
        @error('file')
            <span class="text-danger text-red-600/50">{{ $message }}</span>
        @enderror
        ...
        <span wire:loading class="text-danger text-red-600/50">loading...</span>
        <br>
        {{-- <button wire:loading.remove type="submit"
            class="adu ajp ard arp avz awf bag bbm bir box boy bpa bph">Submit</button> --}}
